...
class SelectAddress extends Component {
  ...
  _getLocationFromLatLong = (lat, lng) => {
    getAddressFromLatLong(lat, lng)
      ...
      .catch(error => {
        console.log(
          '[SelectAddress.js] Get Address from location error : ',
          error,
        );
      });
  };
  ...
  render() {
    ...
    return (
      <View
        ...
        // onRefresh={() => {}}
      >
        <MyStatusBar statusBarColor={colors.primary} />
        ...
        {isAddressViewCollapsed && (
          <Collapsible
            ...
            <TouchableOpacity
              ...
              <Text style={styles.chooseOtherLocation}>
